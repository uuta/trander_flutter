...
class _$_CityState implements _CityState {
  ...
  @override
  String toString() {
    return 'CityState(name: $name, distance: $distance, direction: $direction, countryCode: $countryCode, icon: $icon, rating: $rating, photo: $photo, vicinity: $vicinity, userRatingsTotal: $userRatingsTotal, priceLevel: $priceLevel, lat: $lat, lng: $lng, placeId: $placeId, ratingStar: $ratingStar)';
  }
...
abstract class _CityState implements CityState {
  const factory _CityState(
      ...
      @JsonKey(name: 'ratingStar') final String? ratingStar}) = _$_CityState;
