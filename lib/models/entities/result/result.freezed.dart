...
class _$ResultTearOff {
  ...
  Failure<T> failure<T>(ErrorHandler error) {
    return Failure<T>(
      error,
    );
  }
...
abstract class $FailureCopyWith<T, $Res> {
  ...
  $ErrorHandlerCopyWith<$Res> get error;
}
...
class _$FailureCopyWithImpl<T, $Res> extends _$ResultCopyWithImpl<T, $Res>
  ...
  @override
  $ErrorHandlerCopyWith<$Res> get error {
    return $ErrorHandlerCopyWith<$Res>(_value.error, (value) {
...
abstract class Failure<T> implements Result<T> {
  const factory Failure(ErrorHandler error) = _$Failure<T>;
